...
import { BidPipelineTable } from "./bid/BidPipelineTable";
      ...
      <main className="max-w-[1800px] mx-auto p-6 flex flex-col gap-6">
        ...
        {activeTab === "bids" && (
          <div className="animate-in fade-in duration-300 flex flex-col gap-6">
            ...
            {/* Toolbar */}
            <BidFilters
              view={view} setView={setView} showStarred={showStarred} setShowStarred={setShowStarred}
              search={search} setSearch={setSearch} filter={filter} setFilter={setFilter}
              catFilter={catFilter} setCatFilter={setCatFilter} decisionFilter={decisionFilter} setDecisionFilter={setDecisionFilter}
              bids={bids} isMobileView={isMobileView} setShowAddBid={setShowAddBid}
              openAuditLog={openAuditLog} exportToCSV={exportToCSV}
            />
            ...
            {view === "kanban" ? (
              ...
              <BidPipelineTable
                filteredBids={filteredBids} costData={costData} startupData={startupData}
                expandedRow={expandedRow} setExpandedRow={setExpandedRow} isMobileView={isMobileView}
                sortKey={sortKey} sortDir={sortDir} setSortKey={setSortKey} setSortDir={setSortDir}
                effectiveStatus={effectiveStatus} setSelectedBid={setSelectedBid}
                setStage={setStage} updateMeta={updateMeta} toggleStar={toggleStar} toggleCheck={toggleCheck}
                viewCosts={viewCosts} promoteBid={promoteBid} initProject={initProject}
              />
            )}
